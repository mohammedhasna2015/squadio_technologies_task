...
import 'package:squadio_technologies_task/features/detailsPeople/widget/grid_view_images_people_widget.dart';
  ...
  model) {
    ...
    backgroundColor: Colors.white.withOpacity(0.84),
      body: Column(
        ...
        model.responseDetailsPeopleModel!=null?Text(model
            .responseDetailsPeopleModel!.name??"",
            style: const TextStyle(
                color: Colors.black, fontSize: 18, fontWeight: FontWeight
                .w900)):Container(),

        model.responseDetailsPeopleModel!=null?Text("Adult:${model
            .responseDetailsPeopleModel!.adult!=null?model
            .responseDetailsPeopleModel!.adult.toString():""}",
            style: const TextStyle(
                color: Colors.black, fontSize: 18, fontWeight: FontWeight
                .w900)):Container(),

        model.responseDetailsPeopleModel!=null?Text("Gender:${model
            .responseDetailsPeopleModel!.gender!=null?model
            .responseDetailsPeopleModel!.gender.toString():""}",
            style: const TextStyle(
                color: Colors.black, fontSize: 18, fontWeight: FontWeight
                .w900)):Container(),

        model.responseDetailsPeopleModel!=null?Text("known For "
            "Department:${model
            .responseDetailsPeopleModel!.knownForDepartment??""}",
            style: const TextStyle(
                color: Colors.black, fontSize: 18, fontWeight: FontWeight
                .w900)):Container(),

        model.responseDetailsPeopleModel!=null?Text("birthday${model
            .responseDetailsPeopleModel!.birthday??""}",
            style: const TextStyle(
                color: Colors.black, fontSize: 18, fontWeight: FontWeight
                .w900)):Container(),

        model.listImages.isNotEmpty?GridViewImagesPeopleWidget(list: model
